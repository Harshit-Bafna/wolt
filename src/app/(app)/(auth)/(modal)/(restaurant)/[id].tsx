import { ActivityIndicator, Dimensions, Image, Pressable, ScrollView, SectionList, StyleSheet, Text, View } from 'react-native';
...
export default function Page() {
    ...
    const overlayStyle = useAnimatedStyle(() => {
        const opacity = interpolate(scrollOffset.value, [0, 120], [0, 1], Extrapolation.CLAMP);
                    ...
                    <>
                        ...
                        <View style={styles.whiteContentContainer}>
                            ...
                            <View style={styles.deliveryInfo}>
                                <Pressable style={({ pressed }) => [styles.deliveryButton, pressed && styles.pressed]}>
                                    <Ionicons
                                        name="bicycle"
                                        size={16}
                                        color="#009de0"
                                ...
                                <Pressable style={({ pressed }) => [styles.iconButtonSmall, pressed && styles.pressed]}>
                                    <Ionicons
                                        name="people-outline"
                                        size={20}
                                        color="#009de0"
